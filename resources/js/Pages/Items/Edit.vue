                ...
                <div class="bg-slate-800 rounded-xl border border-slate-700 p-5 grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input v-model="form.barcode_number" type="text" required
                            class="w-full bg-slate-700 text-white px-3 py-2 rounded-lg border border-slate-600 focus:border-emerald-500 outline-none text-sm font-mono transition" />
                    </div>
                    <div>
                    ...
                    <div>
                        <label class="block text-xs text-slate-400 mb-1">Current Qty</label>
                    ...
                    <div>
                        ...
                        <input v-model.number="form.buy_price" type="number" min="0" step="0.01"
                            class="w-full bg-slate-700 text-white px-3 py-2 rounded-lg border border-slate-600 focus:border-emerald-500 outline-none text-sm transition" />
                    </div>
                    <div>
                    ...
                    <div class="col-span-2 flex items-center gap-2">
                        <input v-model="form.price_locked" type="checkbox" id="price_locked" class="w-4 h-4 accent-emerald-500" />
